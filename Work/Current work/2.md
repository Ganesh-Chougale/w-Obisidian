...
/* Search box inside multi-select */
...
.select2-selection--multiple {
    ...
    box-shadow:
        0 0 0 1px rgba(129, 113, 220, 0.18) !important;
}
...
.select2-results__option--highlighted[aria-selected] {
    ...
    background-color: #367CB8 !important;
...
.select2-results__options::-webkit-scrollbar-thumb {
    ...
    /* =========================================================
   SELECT2 3.x OVERRIDE
   This project uses old Select2 because:
   #ddlcustomer.data("select2").containerEventName
   returns "s2id_ddlcustomer"
   ========================================================= */


/* ---------------------------------------------------------
   Remove the custom label arrow.
   Select2 3.x has its own arrow.
   --------------------------------------------------------- */
...
#UpperSection .select2-container-multi
.select2-search-field input::-webkit-input-placeholder {
    color: #AEB6C7 !important;
}

#UpperSection .select2-container-multi
.select2-search-field input:-moz-placeholder {
    color: #AEB6C7 !important;
}
...
#UpperSection .select2-container-multi
.select2-search-field input:-ms-input-placeholder {
    color: #AEB6C7 !important;
}
...
#UpperSection .select2-container-multi.select2-container-active
.select2-choices {
    border-color: #8171DC !important;
...
/* =========================================================
   SELECT2 3.x DROPDOWN
   IMPORTANT:
   Select2 dropdown is normally moved outside #UpperSection.
   Therefore these selectors MUST NOT depend on #UpperSection.
   ========================================================= */
